...
## <a id='toc1_4_'></a>[Datenstand ⏱️](#toc0_)
    ...
    document created:        2025-06-27 11:32:37
...
![png](clin_3_check_files/output_26_1.png)
    ...
    Kombination Geschlecht - ICD10 ungültig: {'C61-W': 24, 'C54-M': 4, 'C51-M': 2, 'C62-W': 2, 'C56-M': 2, 'C58-M': 1, 'C57-M': 1, 'C52-M': 1, 'C63-W': 1, 'C53-M': 1, 'C55-M': 1}
...
![png](clin_3_check_files/output_27_1.png)
    ...
    Kombination Geschlecht - ICD10 ungültig: {'C61-W': 7, 'C62-W': 1, 'C52-M': 1, 'C63-W': 1, 'C56-M': 1}
...
![png](clin_3_check_files/output_32_1.png)
    ...
    │ 2023-11-15   │ 2023-11-15    │     3 │
    │ 2021-11-15   │ 2021-11-15    │     3 │
...
Tests:
    ...
    │ int32 │ boolean  │  boolean  │   int64   │       int64       │                  varchar                   │
    ├───────┼──────────┼───────────┼───────────┼───────────────────┼────────────────────────────────────────────┤
...
![png](clin_3_check_files/output_43_1.png)
...
![png](clin_3_check_files/output_44_1.png)
...
![png](clin_3_check_files/output_46_1.png)
...
![png](clin_3_check_files/output_47_1.png)
...
![png](clin_3_check_files/output_49_1.png)
...
![png](clin_3_check_files/output_50_1.png)
...
> in den meisten Gruppen stammen die Duplikate nicht von einem einzelnen Patienten  
    ...
    🟧 🗄️ klin
    10_554 Fälle verteilen sich auf 5_161 Gruppen mit max 4 Fällen in einer Gruppe
    Anzahl Gruppen, in denen alle Fälle das gleiche Merkmal aufweisen: REGISTER {True: 4955, False: 206}
    Anzahl Gruppen, in denen alle Fälle das gleiche Merkmal aufweisen: PATIENTID {False: 4525, True: 636}
