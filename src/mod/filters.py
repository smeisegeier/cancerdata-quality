...
FILTERS_OP_COUNT = ("z_tum_op_count > 0","> 0 OP")
FILTERS_OP_LT_180D = ("z_tum_id in (select distinct z_tum_id from OP where z_period_diag_op_day < 180)","Tumor hat OP < 180d nach Diagnose")
